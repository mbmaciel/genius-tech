...
export const FullHistoryDigitDisplay = React.memo(function FullHistoryDigitDisplayInner({
  ...
  return (
    <Card className="bg-[#13203a] p-4 shadow-lg border border-[#2a3756]">
      ...
      {/* Exibição grande e destacada do último dígito (que agora está no início do array) */}
      ...
      <div className="mb-4">
        <div className="text-xs text-gray-400 mb-2 font-medium">Histórico de dígitos: <span className="text-xs text-red-400 font-bold">(ordem da esquerda para direita - o mais recente é o primeiro à esquerda!)</span></div>
        {isLoading ? (
